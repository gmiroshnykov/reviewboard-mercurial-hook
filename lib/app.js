...
function validate(params, callback) {
  return async.parallel([
    ...
    validateCredentials.bind(null, params.username, params.password)
  ], callback);
}
...
function validateCredentials(username, password, callback) {
  ...
  return bugzilla.getUser(username, options, function(err, user) {
    if (err) return callback(err);
 ...
 */
function processChangegroup(bugId, node, callback) {
