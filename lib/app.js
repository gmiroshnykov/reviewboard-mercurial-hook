      ...
      function(err) {
        ...
        return createReviewRequestDraft(reviewRequestId, changeset,
          function(err, reviewRequestDraft) {
            ...
            return reviewboard.getReviewRequest(reviewRequestId,
              function(err, reviewRequest) {
                if (err) return callback(err);
                reviewRequest.commit_id = reviewRequestDraft.commitId,
                reviewRequest.summary = reviewRequestDraft.summary,
                reviewRequest.description = reviewRequestDraft.description;
