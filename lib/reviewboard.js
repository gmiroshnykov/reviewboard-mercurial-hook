...
ReviewBoard.prototype.getReviewRequestDraft = function(reviewRequestId, callback) {
...
ReviewBoard.prototype.uploadDiff = function(reviewRequestId, options, callback) {
  ...
  if (options.parentDiffPath) {
    form.append('parent_diff_path', options.parentDiffPath, {filename: 'patch.diff'});
  }
};
